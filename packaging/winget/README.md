...
```powershell
winget validate --manifest packaging\winget\0.2.2
```
...
```powershell
winget install --manifest packaging\winget\0.2.2
```
...
```powershell
$dst = "<fork>\manifests\x\Xcomart\Rudbman\0.2.2"
New-Item -ItemType Directory -Force $dst
Copy-Item packaging\winget\0.2.2\*.yaml $dst
```
