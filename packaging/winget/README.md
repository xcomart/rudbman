...
```powershell
winget validate --manifest packaging\winget\0.1.7
```
...
```powershell
winget install --manifest packaging\winget\0.1.7
```
...
```powershell
$dst = "<fork>\manifests\x\Xcomart\Rudbman\0.1.7"
New-Item -ItemType Directory -Force $dst
Copy-Item packaging\winget\0.1.7\*.yaml $dst
```
