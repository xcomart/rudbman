...
```powershell
winget validate --manifest packaging\winget\0.2.3
```
...
```powershell
winget install --manifest packaging\winget\0.2.3
```
...
```powershell
$dst = "<fork>\manifests\x\Xcomart\Rudbman\0.2.3"
New-Item -ItemType Directory -Force $dst
Copy-Item packaging\winget\0.2.3\*.yaml $dst
```
