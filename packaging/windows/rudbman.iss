...
; in-app updater downloads and unpacks (rugpui-shell, pointed at this product by
...
;
;   ISCC.exe /DVersion=0.2.4 ^
;            /DSourceDir=<staging tree> ^
;            /DOutputDir=<where the .exe lands> ^
;            /DOutputBaseFilename=rudbman-v0.2.4-x86_64-pc-windows-msvc-setup
;
