...
/// (they are supplied by the caller; see [`WindowControlIcons`]) and why their
/// resting tint is
/// [`Theme::icon`](crate::theme::Theme#structfield.icon) rather than the muted
...
///
/// Passed in rather than named here, the way [`crate::TabBar`] takes its
